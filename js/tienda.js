...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    let productoLocalStorage = localStorage.getItem("listaCarrito")

    if(productoLocalStorage ){
        listaCarrito = JSON.parse(productoLocalStorage)
...
function pintarProductosEnCarrito() {
    ...
    const guardarproducto = localStorage.setItem("listaCarrito", JSON.stringify(listaCarrito))
...
// const btnColorMode = document.querySelector("#btnToggleMode");
